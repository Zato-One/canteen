...
public class ParametersManager {
     ...
     *
     * @param capacity Total number of seats in canteen
     */
     ...
     * queue.
     *
     * @param std Value of standart deviation (only positive value)
     */
     ...
     *
     * @param mean Value of mean (where the peak will be)
     */
    ...
    /**
     * Set standart deviation value for gaussian ranodom generator in eating state
     * queue.
     *
     * @param std Value of standart deviation (only positive value)
     */
